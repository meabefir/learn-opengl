...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("vertex10.vert", "fragment10.frag");
    Shader lightCubeShader("vertex10.vert", "fragment_light_source2.frag");
    ...
    glm::vec3 basePointLightPositions[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("spotLight.outerCutOff", glm::cos(glm::radians(4.5f)));
